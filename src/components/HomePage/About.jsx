...
const About = () => {
    ...
    return (
        <Flex height={["", "", "", "100vh"]} className="roboto" alignItems="center" w={["95%", "95%", "90%", "80%"]} m="auto" justifyContent="space-between" flexDir={["column-reverse", "column-reverse", "row", "row"]}>
            <Box w={["90%", "90%", "40%", "40%"]} >
                <Text fontSize={["2xl", "2xl", "xl", "3xl"]} fontWeight="bold" my="5" color="crimson" >About.</Text>
                <Text fontSize={["xl", "2xl", "2xl", "4xl"]} className="boldFont" opacity="0.8" >Number of Benefits of Gymnastics </Text>
            ...
            <Flex position="relative" justifyContent="center" alignItems="center" mt={["16", "16", "", ""]} w={["100%", "100%", "50%", "50%"]} >
                ...
                <Image boxShadow="0 0 15px gray" src="./w3.jpg" alt="image" w="80%" ></Image>
            </Flex>
        </Flex>
    )
}
