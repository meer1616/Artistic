            ...
            <Fade>
                <Box>
                    ...
                    <Text textAlign="center" color="crimson" className="roboto"
                        fontSize={["xl", "xl", "2xl", "2xl"]} fontWeight="bold" letterSpacing="wider" mt={["5", "5", "", ""]} >Our Tour</Text>
                ...
                <Box w={["100%", "100%", "50%", "50%"]}>
                    <Fade>
                        <Box w={["100%", "100%", "90%", "80%"]} margin="auto">
                            ...
                            <Button onClick={handleJoinNow} mt="10" borderRadius="20" px="7" boxShadow="lg" _hover={{ color: "white", backgroundColor: "gray" }} backgroundColor="crimson" color="white" mb={["8", "8", "", ""]}>Join Now</Button>
                        </Box>
                    </Fade>
